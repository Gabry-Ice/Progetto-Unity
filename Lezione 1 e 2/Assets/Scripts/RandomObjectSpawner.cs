...
public class RandomObjectSpawner : MonoBehaviour
{
    ...
    private void Start()    //validazione dei dati
    {
        // Validate references
    ...
    private void Update()
    {
        ...
        {
            SpawnObject(); //portiamo in scena l'oggetto
            SetNextSpawnTime();//cacolo l'intervallo di tempo per il prossimo spawn
        }
    }
    ...
    private void SpawnObject()
    {
        ...
        //calcolo punto randomico in base alla dimensione del piano
        ...
        //determiniamo le coordinate di spawn
        ...
        //instanziamo dicendo che oggetto da generare, le sue coordinate, la rotazione e un riferimento di dove spawnarlo(opzionale)
